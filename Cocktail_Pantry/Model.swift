...
let daiquiri = Cocktail(name: "Daiquiri", methods: [.shaken], videoID: "fyZ4bwuPuiI", tutorialStartTime: minutesStringtoSecondsInt(numberToConvert: "03:14"), imageURL: "https://cocktail-photos-cocktailpantry.s3.amazonaws.com/daquiri_edited.jpg", history: """
...
let daiquiriHemingway = Cocktail(name: "Hemingway Daiquiri", methods: [.shaken], videoID: "pKbISuGkKBI", tutorialStartTime: minutesStringtoSecondsInt(numberToConvert: "00:39"), imageURL: "https://cocktail-photos-cocktailpantry.s3.amazonaws.com/hemmingway+daquiri_edited.jpg", history: """
...
let ginFizz = Cocktail(name: "Gin Fizz", methods: [.shaken], videoID: "obGhGNUKx30", tutorialStartTime: minutesStringtoSecondsInt(numberToConvert: "00:44"), imageURL: "https://cocktail-photos-cocktailpantry.s3.amazonaws.com/gin+fizz_edited.jpg", history: nil,
                       ingQuantities: [1.5, 0.75, 0.75, 1, 0], ingTypes: [.oz, .oz, .oz, .none, .top], ingNames: ["gin", "lemon juice", "simple syrup", "egg white", "seltzer"], instructions: ["add egg white into big tin of shaker", "pour gin, lemon juice and simple syrup into small tin", "combine and close tins together.", "let sit for 10 seconds then shake for 10", "add big rock of ice and shake hard", "double strain into chilled glass", "top with soda"], countryOfOrigin: "United States", glassType: [.highball], iceType: .neat, shakeOrStirTime: ShakeOrStirTime(minTime: 10, maxTime: 20), boozeLevel: .low, flavorProfile: [.refreshing, .sparkling], dryShake: true, difficultyLevel: .difficult, backgroundColor: CodableColor(red: 204, green: 255, blue: 255))

let manhattan = Cocktail(name: "Manhattan", methods: [.stirred], videoID: "wiOxt4J5zaM", tutorialStartTime: minutesStringtoSecondsInt(numberToConvert: "01:32"), imageURL: "https://cocktail-photos-cocktailpantry.s3.amazonaws.com/manhattan_edited.jpg",
                         history: """
    ...
    """,
                         ingQuantities: [2, 1, 4], ingTypes: [.oz, .oz, .dash], ingNames: ["rye whiskey", "sweet vermouth", "angostura bitters"], garnish: ["brandied cherry"], instructions: ["pour all ingreidients into mixing glass", "add ice and stir until chilled", "strain into chilled glass and garnish"], countryOfOrigin: "United States", glassType: [.martini], iceType: .neat, shakeOrStirTime: ShakeOrStirTime(minTime: 20, maxTime: 40), boozeLevel: .high, flavorProfile: [.boozy, .sweet], dryShake: false, difficultyLevel: .easy, backgroundColor: CodableColor(red: 153, green: 0, blue: 0))

let margaritaOriginal = Cocktail(name: "Original Margarita", methods: [.shaken], videoID: "OWD2FAZ9IOQ", tutorialStartTime: minutesStringtoSecondsInt(numberToConvert: "00:22"), imageURL: "https://cocktail-photos-cocktailpantry.s3.amazonaws.com/original+margarita_edited.jpg", history: nil,
...
let margaritaTommy = Cocktail(name: "Tommy's Margarita", methods: [.shaken], videoID: "OWD2FAZ9IOQ", tutorialStartTime: minutesStringtoSecondsInt(numberToConvert: "03:38"), imageURL: "https://cocktail-photos-cocktailpantry.s3.amazonaws.com/tommys+marg_edited.jpg", history: nil,
...
let moscowMule = Cocktail(name: "Moscow Mule", methods: [.built], videoID: "69wSCFe4GAI", tutorialStartTime: minutesStringtoSecondsInt(numberToConvert: "04:12"), imageURL: "https://cocktail-photos-cocktailpantry.s3.amazonaws.com/moscow+mule_edited.jpg",
                          history: """
...
let negroni = Cocktail(name: "Negroni", methods: [.built, .stirred], videoID: "sAyK8_MySWw", tutorialStartTime: minutesStringtoSecondsInt(numberToConvert: "02:47"), imageURL: "https://cocktail-photos-cocktailpantry.s3.amazonaws.com/negroni_edited.jpg", history: """
...
let oldFashioned = Cocktail(name: "Old Fashioned", methods: [.built, .stirred], videoID: "SeP3V3MtpxI", tutorialStartTime: minutesStringtoSecondsInt(numberToConvert: "03:03"), imageURL: "https://cocktail-photos-cocktailpantry.s3.amazonaws.com/old+fashioned_edited.jpg", history: """
    ...
    """
                            , ingQuantities: [2, 1, 4, 1], ingTypes: [.oz, .cube, .dash, .dash], ingNames: ["whiskey", "sugar", "angostura bitters", "seltzer"], garnish: ["orange twist"], instructions: ["place sugar in glass", "add bitters and soda", "muddle and stir to combine", "add whiskey and ice", "stir until chilled and garnish"], countryOfOrigin: "United States", glassType: [.rocks], iceType: .big, shakeOrStirTime: ShakeOrStirTime(minTime: 30, maxTime: 60), boozeLevel: .medium, flavorProfile: [.strong], dryShake: false, difficultyLevel: .difficult, backgroundColor: CodableColor(red: 255, green: 128, blue: 0))

let sazerac = Cocktail(name: "Sazerac", methods: [.stirred], videoID: "RuZzOcjJUYw", tutorialStartTime: minutesStringtoSecondsInt(numberToConvert: "00:44"), imageURL: "https://cocktail-photos-cocktailpantry.s3.amazonaws.com/sazerac_edited.jpg",
                       history: """
    ...
    """
                       , ingQuantities: [2, 1, 4, 1], ingTypes: [.oz, .cube, .dash, .dash], ingNames: ["rye whiskey", "sugar", "peychauds bitters", "absinthe"], garnish: ["lemon twist"], instructions: ["wash chilled glass with absinthe", "add sugar, bitters and whiskey and muddle", "add ice and stir until chilled", "strain into prepared glass and garnish"], countryOfOrigin: "United States", glassType: [.rocks], iceType: .neat, shakeOrStirTime: ShakeOrStirTime(minTime: 15, maxTime: 20), boozeLevel: .medium, flavorProfile: [.boozy, .bitter], dryShake: false, difficultyLevel: .difficult, backgroundColor: CodableColor(red: 255, green: 153, blue: 51))

let whiskeySour = Cocktail(name: "Whiskey Sour", methods: [.shaken], videoID: "hFKZPzfngcU", tutorialStartTime: minutesStringtoSecondsInt(numberToConvert: "04:18"), imageURL: "https://cocktail-photos-cocktailpantry.s3.amazonaws.com/whiskey+sour_edited.jpg", history: """
    ...
    """
                           , ingQuantities: [2, 0.75, 0.75, 1], ingTypes: [.oz, .oz, .oz, .none], ingNames: ["whiskey", "lemon juice", "simple syrup", "egg white"], garnish: ["angostura bitters"], instructions: ["Add egg white into big tin of shaker", "Pour whiskey, lemon juice and simple syrup into small tin", "Combine and close tins together", "Let sit for 10 seconds then shake for 30", "Add big rock of ice and shake hard", "Double strain into chilled glass and garnish"], countryOfOrigin: "United States", glassType: [.martini, .coupe], iceType: .neat, shakeOrStirTime: ShakeOrStirTime(minTime: 12, maxTime: 15), boozeLevel: .medium, flavorProfile: [.sour, .aromatic, .creamy], dryShake: false, difficultyLevel: .difficult, backgroundColor: CodableColor(red: 255, green: 255, blue: 102))
